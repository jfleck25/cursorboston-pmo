    ...
    <>
      <div className="pointer-events-none fixed bottom-6 left-0 right-0 z-30 flex justify-center px-4">
        <motion.button
          ...
          className="group relative flex items-center gap-2 overflow-hidden rounded-full border-2 border-ship bg-ship px-6 py-3 font-mono text-sm font-bold uppercase tracking-[0.08em] text-surface shadow-ship transition hover:shadow-[0_0_28px_rgba(0,255,102,0.45)]"
          whileTap={
